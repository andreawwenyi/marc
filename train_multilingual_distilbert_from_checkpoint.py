...
def finetune_mdistilbert(checkpoint_path, model_lang):
    num_train_epochs = 3
    model_output_path = f'./models/mdistilbert-{model_lang}-epoch-{num_train_epochs + 3}'
    ...
    model = AutoModelForSequenceClassification.from_pretrained(checkpoint_path).to(device_name)
...
if __name__ == '__main__':
    ...
    finetune_mdistilbert(args.checkpoint_path, args.model_lang)
